...
def train_lvl2(
    ...
    final_model_path = (
        config.model_save_dir
        / f"{config.mlflow_experiment}_{mlflow.active_run().info.run_name}_stagelvl2_{total_steps}.pth"
    )
    ...
    best_optimizer_path = (
        config.model_save_dir
        / f"{config.mlflow_experiment}_{mlflow.active_run().info.run_name}_stagelvl2_best_optimizer.pth"
    )
