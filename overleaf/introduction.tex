...
\begin{itemize}
  ...
  \item a gradient-level analysis of the objectives showing the accuracy-versus-PET-preservation trade-off;
  \item a score-driven checkpoint and submission selection procedure that mirrors the challenge ranking. \todo{finalise once the model is fixed}
\end{itemize}
