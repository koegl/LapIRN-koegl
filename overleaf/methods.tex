...
All four PET preservation terms are used during training and descended at test time by our instance optimisation, so the network is trained on the objective it is later refined under.
