...
We regularise the displacement field using a diffusion term, $\mathcal{L}_{\mathrm{smooth}}$, defined as the mean squared spatial gradient of the displacement, together with a penalty for non-diffeomorphic voxels.
